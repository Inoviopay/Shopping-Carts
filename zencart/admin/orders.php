                ...
                if (($check_status->fields['orders_status'] != $status) || zen_not_null($comments)) {
                  ...
                  //send extra emails
                      ...
                      // hide comment
                        ...
                        // Inovio refund functionality
          
                    if ($orders_statuses[$status-1]['text'] == "Inovio Refund [$status]") {
                          require("../includes/modules/payment/inovio_cc.php");

                          $inovio_refund_ob = new inovio_cc();
                        if ($inovio_refund_ob->inovio_refund($_GET['oID']) === true) {
                            $comments = "Refund has been succesfully completed using inovio payment method";
                        } else {
                            $comments = "Something went wrong with Inovio API response";
                        }
                    }
                  // End inovio refund functionality
