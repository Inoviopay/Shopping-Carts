...
class InovioServiceConfig
{
    ...
    public function serviceConfig($conf = array(), $InnovioConnnection = null)
    {
        $this->curl = $InnovioConnnection;
    ...
    private function handleResponse($response) {
        ...
        if ( !empty($response['curl_error']) || $response['curl_errno'] >0 || $response['curl_getinfo']['http_code']!=200) {
            throw new Exception("Error in payment processing request, please contact to your service provider.");
        }
